...
<html>
    ...
    <body>
        ...
        <!-- header div starts -->
        <div class="container-fluid bg-secondary header_div">
            <div class="container">
                <div class="row">
                    <div class="col-4" >
                        <a href="home.jsp" class="navbar-brand text-light"  >GREY RULE</a>
                    </div>
                    <div class="col-3 ">
                    </div>
                    <div class="col-5">
                        <a href="profile.jsp" style="text-decoration: none">
                        <image src="profile-pics/<%=profile_pic%>" alt="" class="img-fluid dp_img_style" />
                        <span class="text-light"> <%= session.getAttribute("session_name")%></span>
                        </a>
                        &nbsp;&nbsp;
                        <button type="button" class="btn btn-info dropdown-toggle dropdown-toggle btn-sm" data-bs-toggle="dropdown">More</button>
            ...
            <div class="container">
                <div class="row" style="padding: 40px">
                            ...
                            <div class="position-sticky">
                                <div class="list-group list-group-flush mx-3 mt-4">
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action py-2 ripple">
                                        <i class="bi bi-wechat"></i> <span>Messenger</span>
                                    </a>
                                    <a href="#" class="list-group-item list-group-item-action py-2 ripple">
                    ...
                    <div class="col-9">
                        <div class="row" >
                            <div class="col-3">
                                <img src="profile-pics/<%=profile_pic%>" alt="" class="profile_pic_design"/>
                            </div>
                            <div class="col-9" style="">
                                <a href="edit-my-profile.jsp"> <i class="bi bi-pencil-fill" style="float: right"></i></a>
                                <h3 class="text-secondary" > <%= session.getAttribute("session_name")%></h3>
                            ...
                            <div class="col-12 p-3">
                                <div class="shadow p-4 mb-5 bg-body rounded">
                                    ...
                                    <form action="UploadStatus" method="post" enctype="multipart/form-data">
                                        <textarea name = "status_text" class="status_textarea_design" placeholder="What are your thoughts"></textarea>
                                        <input type="file" name = "status_img" class="form-control" style="width:100%" /><br/>
